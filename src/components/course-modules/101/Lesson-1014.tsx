...
export default function Lesson1014() {
    ...
    return (
        ...
        <SLT id="101.4">Puedo configurar un ambiente local para desarrollar Plutus utilizando un nix shell, y utilizarlo para compilar un script en formato .plutus</SLT>
